            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data" class="mt-3 flex flex-col">
                        ...
                        <div class="form-group flex justify-end">
                            <label class="text-black dark:text-white" for="title">Brand:</label>
                        ...
                        <div class="form-group flex justify-end">
                            <label class="text-black dark:text-white" for="title">Weight (single):</label>
                        ...
                        <div class="form-group flex justify-end">
                            <label class="text-black dark:text-white" for="title">Unit count (total):</label>
                        ...
                        <div class="form-group flex justify-end">
                            <label class="text-black dark:text-white" for="title">Flavor (injectable or oral tablet):</label>
                        ...
                        <div class="form-group flex justify-end">
                            <label class="text-black dark:text-white" for="title">Primary Supplement Type (Injectable or oral tablet):</label>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mt-3">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="p-3 bg-gray-800 dark:bg-gray-700 w-auto min-h-12 h-auto rounded-lg m-3">
                        ...
                        <div class="flex flex-row justify-between">
                            Brand<p class="text-gray-400">{{ $item->caliber }}</p>
                        </div>
                        <div class="flex flex-row justify-between">
                            Weight<p class="text-gray-400">{{ $item->mass }}</p>
                        </div>
                        <div class="flex flex-row justify-between">
                            Unit count<p class="text-gray-400">{{ $item->explosive_type }}</p>
                        </div>
                        <div class="flex flex-row justify-between">
                            Flavor<p class="text-gray-400">{{ $item->explosive_mass }}</p>
                        </div>
                        <div class="flex flex-row justify-between">
                            Primary Supplement Type<p class="text-gray-400">{{ $item->tnt }}</p>
                        </div>
                        <!-- <div class="flex flex-row justify-between">
